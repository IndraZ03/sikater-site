                ...
                <tbody>
                    ...
                    <?php foreach ($dokumen_poolbar as $dokumen_poolbarr) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $dokumen_poolbarr->tanggal_acc_k; ?></td>
                            ...
                            <td class="text-center">
                                ...
                                } elseif ($dokumen_poolbarr->status_kasubid == '1' || $dokumen_poolbarr->$status_kasubid == '2') {
                                    if ($dokumen_poolbarr->status_kasubid == '1') {
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="post" action="<?= base_url('upload/status_kasubid_poolbar'); ?>">
