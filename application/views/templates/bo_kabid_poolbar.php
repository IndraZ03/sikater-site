            ...
            <table class="table  table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <?php foreach ($dokumen_poolbar as $dokumen_poolbarr) { ?>
                        <?php if ($dokumen_poolbarr->status_kasubid == '1') { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $dokumen_poolbarr->tanggal_acc_kd; ?></td>
                                ...
                                <span><button class='btn btn-danger text-center' data-toggle='modal' data-target='#KomentarModalReject$dokumen_poolbarr->id' width=' 555' height='85'>Ditolak</button></span>";
                                    } elseif ($dokumen_poolbarr->status_kabid == '1' || $dokumen_poolbarr->status_kabid == '2') {
                                        if ($dokumen_poolbarr->status_kabid == '1') {
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="post" action="<?= base_url('upload/status_kabid_poolbar'); ?>">
                                                        <div class=" form-group">
                                                            ...
                                                            <input type="hidden" id="status_kabid" name="status_kabid" value="1">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="post" action="<?= base_url('upload/status_kabid_poolbar'); ?>">
                                                        <div class=" form-group">
                                                            ...
                                                            <input type="hidden" id="status_kabid" name="status_kabid" value="2">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                                            <button type="submit" class="btn btn-success">Kirim </button>
