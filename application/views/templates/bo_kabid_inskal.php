            ...
            <table class="table  table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <?php foreach ($dokumen_inskal as $dokumen_inskall) { ?>
                        <?php if ($dokumen_inskall->status_kasubid == '1') { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $dokumen_inskall->tanggal_acc_kd; ?></td>
                                ...
                                <td class="text-center">
                                    ...
                                    } elseif ($dokumen_inskall->status_kabid == '1' || $dokumen_inskall->status_kabid == '2') {
                                        if ($dokumen_inskall->status_kabid == '1') {
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="post" action="<?= base_url('upload/status_kabid_inskal'); ?>">
