            ...
            <table class="table  table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <?php foreach ($dokumen_inskal as $dokumen_inskall) { ?>
                        <?php if ($dokumen_inskall->status_kabid == '1') { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $dokumen_inskall->tanggal_acc_kb; ?></td>
                                ...
                                <span><button class='btn btn-danger text-center' data-toggle='modal' data-target='#KomentarModalReject$dokumen_inskall->id' width=' 555' height='85'>Ditolak</button></span>";
                                    } elseif ($dokumen_inskall->status_kabal == '1' || $dokumen_inskall->status_kabal == '2') {
                                        if ($dokumen_inskall->status_kabal == '1') {
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="post" action="<?= base_url('upload/status_kabal_inskal'); ?>">
