                        ...
                        <?php if ($dokumen_inskall->status_kabal == '1') { ?>
                            <tr>
                                ...
                                <form method="post" action="<?= base_url() ?>upload/download_sekbal_inskal" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" value="<?= $dokumen_inskall->id; ?>" id="id" name="id">
                                    <input type="hidden" value="1" id="status_sekbal" name="status_sekbal">
                                    <td>
                                        <button type="button" data-toggle="modal" data-target="#Kirimdok<?php echo $dokumen_inskall->id ?>" class="btn btn-success">Kirim Dokumen </button>
