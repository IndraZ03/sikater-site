...
<div class="container">
    ...
    <div class="row mr-sm-4 ml-sm-7  ml-3 mb-5 mt-6 text-center">
        <div class="col-md-4 col-sm-6">
            <a href="<?= base_url('user/bidang_observasi'); ?>">
                <div class=" serviceBox shadow-lg rounded">
                    <span>
                        <h3 class="title text-uppercase">Bidang I Observasi </h3> <br>
        ...
        <div class="col-md-4 col-sm-6 text-center">
            <div class="serviceBox shadow-lg rounded">
                <span>
                    <h3 class="title text-uppercase">Sistem Koordinasi Sertifikat
Expired Date Calibration (Peralatan MKG)
</h3>
                </span>
                <span class='service-icon text-center'>
        ...
        <div class="col-md-4 col-sm-6 text-center">
            <a href="<?= base_url('user/logbook'); ?>">
                
                <div class="serviceBox shadow-lg rounded">
                    <span>
                        <h3 class="title text-uppercase">Logbook Kalibrasi Laboratorium </h3> <br>
                    <span class='service-icon text-center'>
    ...
    <div class="row mr-sm-4 ml-sm-7 ml-3 mb-5 mt-6 justify-content-center">
        ...
        <div class="col-md-4 col-sm-6 text-center">
            <a>
                <div class="serviceBox shadow-lg rounded">
                    <span>
                        <h3 class="title text-uppercase">New Menu</h3>
                    </span>
                    <span class='service-icon text-center'>
...
<footer class="bg-light text-center text-lg-start">
  ...
  <div class="text-center text-dark p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2023 Copyright:
    <a class="text-dark" href="https://mdbootstrap.com/">Khindi Aufa Hibatullah</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
